...
class SettingsViewModel : ViewModel() {
    ...
    private var _epgCacheEnable by mutableStateOf(true)
    var epgCacheEnable: Boolean
        get() = _epgCacheEnable
        set(value) {
            _epgCacheEnable = value
            Configs.epgCacheEnable = value
            afterSetWhenCloudSyncAutoPull()
        }

    private var _epgCacheTimeHours by mutableIntStateOf(24)
    var epgCacheTimeHours: Int
        get() = _epgCacheTimeHours
        set(value) {
            _epgCacheTimeHours = value
            Configs.epgCacheTimeHours = value
            afterSetWhenCloudSyncAutoPull()
        }
    ...
    private var _iptvSourceCacheEnable by mutableStateOf(true)
    var iptvSourceCacheEnable: Boolean
        get() = _iptvSourceCacheEnable
        set(value) {
            _iptvSourceCacheEnable = value
            Configs.iptvSourceCacheEnable = value
            afterSetWhenCloudSyncAutoPull()
        }

    private var _iptvSourceCacheTimeHours by mutableIntStateOf(24)
    var iptvSourceCacheTimeHours: Int
        get() = _iptvSourceCacheTimeHours
        set(value) {
            _iptvSourceCacheTimeHours = value
            Configs.iptvSourceCacheTimeHours = value
            afterSetWhenCloudSyncAutoPull()
        }

    private var _channelLogoCacheEnable by mutableStateOf(true)
    var channelLogoCacheEnable: Boolean
        get() = _channelLogoCacheEnable
        set(value) {
            _channelLogoCacheEnable = value
            Configs.channelLogoCacheEnable = value
            afterSetWhenCloudSyncAutoPull()
        }
    ...
    private var _uiLowPerformanceMode by mutableStateOf(false)
    var uiLowPerformanceMode: Boolean
        get() = _uiLowPerformanceMode
        set(value) {
            _uiLowPerformanceMode = value
            Configs.uiLowPerformanceMode = value
            afterSetWhenCloudSyncAutoPull()
        }

    private var _uiChannelGridColumns by mutableIntStateOf(5)
    var uiChannelGridColumns: Int
        get() = _uiChannelGridColumns
        set(value) {
            _uiChannelGridColumns = value
            Configs.uiChannelGridColumns = value
            afterSetWhenCloudSyncAutoPull()
        }

    private var _uiEpgUpdateIntervalMs by mutableLongStateOf(30_000L)
    var uiEpgUpdateIntervalMs: Long
        get() = _uiEpgUpdateIntervalMs
        set(value) {
            _uiEpgUpdateIntervalMs = value
            Configs.uiEpgUpdateIntervalMs = value
            afterSetWhenCloudSyncAutoPull()
        }

    private var _uiSimplifyChannelItem by mutableStateOf(false)
    var uiSimplifyChannelItem: Boolean
        get() = _uiSimplifyChannelItem
        set(value) {
            _uiSimplifyChannelItem = value
            Configs.uiSimplifyChannelItem = value
            afterSetWhenCloudSyncAutoPull()
        }

    val isLowPerformanceMode: Boolean
        get() = _uiLowPerformanceMode || _uiSimplifyChannelItem
    ...
    private var _themeTextureAlpha by mutableFloatStateOf(0.8f)
    var themeTextureAlpha: Float
        get() = _themeTextureAlpha
        set(value) {
            _themeTextureAlpha = value
            Configs.themeTextureAlpha = value
            afterSetWhenCloudSyncAutoPull()
        }
    ...
    private var _channelAudioTrackMemory by mutableStateOf("")
    var channelAudioTrackMemory: String
        get() = _channelAudioTrackMemory
        set(value) {
            _channelAudioTrackMemory = value
            Configs.channelAudioTrackMemory = value
        }

    private var _audioTrackSortMode by mutableStateOf(Configs.AudioTrackSortMode.LANGUAGE)
    var audioTrackSortMode: Configs.AudioTrackSortMode
        get() = _audioTrackSortMode
        set(value) {
            _audioTrackSortMode = value
            Configs.audioTrackSortMode = value
        }
    ...
    fun refresh() {
        ...
        _epgCacheEnable = Configs.epgCacheEnable
        _epgCacheTimeHours = Configs.epgCacheTimeHours
        _epgSourceList = Configs.epgSourceList
        _iptvSourceCacheEnable = Configs.iptvSourceCacheEnable
        _iptvSourceCacheTimeHours = Configs.iptvSourceCacheTimeHours
        _channelLogoCacheEnable = Configs.channelLogoCacheEnable
        ...
        _uiLowPerformanceMode = Configs.uiLowPerformanceMode
        _uiChannelGridColumns = Configs.uiChannelGridColumns
        _uiEpgUpdateIntervalMs = Configs.uiEpgUpdateIntervalMs
        _uiSimplifyChannelItem = Configs.uiSimplifyChannelItem
