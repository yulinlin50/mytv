...
fun SettingsThemeScreen(
    ...
    AppScreen(
        ...
        LazyColumn(
            ...
            itemsIndexed(allAppThemeDefGroup) { index, group ->
                AppThemeDefList(
...
private fun AppThemeDefItem(
    ...
    Surface(
        ...
        AppThemeWrapper(appThemeDef = appThemeDef) {
    ...
    Surface(
        ...
        Column(modifier = Modifier.fillMaxWidth()) {
            ...
            LazyRow(
                ...
                itemsIndexed(appThemeDefList) { index, def ->
                    AppThemeDefItem(
                        modifier = firstItemFocusRequester
                            ?.takeIf { index == 0 }
